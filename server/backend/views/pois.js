...
app.controller('PoisCtrl', function($scope, $http, $document, $routeParams, Upload, $rootScope, $mdDialog) {
  ...
  $scope.$watch('poi.activo', function (a, d) {
      console.log(a +'-'+ d)
      if(a==1)  $scope.poi.activo = true;
      else  $scope.poi.activo = false;
    ...
    $scope.eliminar = function ($item, ev){
        ...
        var confirm = $mdDialog.confirm()
                                        ...
                                        .title('Alerta')
                                        .content('Seguro que quieres eliminar este poi?')
